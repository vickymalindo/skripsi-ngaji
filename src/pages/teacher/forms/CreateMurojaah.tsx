...
import { postMurojaah } from '../../../fetch/api/Teacher';
...
const CreateMurojaah = () => {
  ...
  const handleClick = async () => {
    if (token) {
      ...
      const { status } = await postMurojaah(surah, juz, ayat, decryptedToken);
      if (status === 200) {
